...
// Порівнюємо числа між собою. Порівнюємо перших два числа і більше записуємо до змінної.
// Далі порівнюємо записане максимальне число з кожним наступним елементом масиву і якщо якесь число більше максимально то записуємо його в змінну.
...
// Порівнюємо числа між собою. Порівнюємо перших два числа і менше записуємо до змінної.
// Далі порівнюємо записане мінімальне число з кожним наступним елементом масиву і якщо якесь число менше мінімального то записуємо його в змінну.
...
// Знаходимо кількість елементів масиву
// Визначаємо середнє арифметичне поділивши суму всіх чисел на кількість елементів в масиві
...
// Знаходимо найбільшу послідовність чисел, які зростають
// Перевіряємо чи наступне число більше попереднього. Якщо більше то записуємо в масив currentSequence.
// Якщо послідовність обривається то currentSequence очищується і знову шукаємо наступну послідовність чисел.
// Якщо довжина масиву currentSequence більша за довжину масиву maxSequence то записуємо currentSequence в maxSequence.
...
// Знаходимо найбільшу послідовність чисел, які зменшуються
// Перевіряємо чи наступне число менше попереднього. Якщо менше то записуємо в масив currentSequence.
// Якщо послідовність обривається то currentSequence очищується і знову шукаємо наступну послідовність чисел.
// Якщо довжина масиву currentSequence більша за довжину масиву maxSequence то записуємо currentSequence в maxSequence.
