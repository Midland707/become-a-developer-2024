...
// Далі порівнюємо записане максимальне число з кожним елементом масиву і якщо якесь число більше максимально то записуємо його в змінну.
...
// Далі порівнюємо записане мінімальне число з кожним елементом масиву і якщо якесь число менше мінімального то записуємо його в змінну.
